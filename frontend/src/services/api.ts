...
export const payslipApi = {
  ...
  setPassword: (data: { oldPassword?: string; newPassword: string }) => api.post('/api/employees/my/set-payslip-password', data),
  // HR/SA
  passwordInfo: (employeeId: string) => api.get(`/api/employees/${employeeId}/payslip-password-info`),
