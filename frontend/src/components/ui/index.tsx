...
export function Modal({ open, onClose, title, children, footer, size = 'md' }: {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className={clsx('relative bg-white rounded-2xl shadow-2xl w-full animate-slide-up max-h-[90vh] flex flex-col', widthClass)}>
        ...
        {footer && (
          <div className="px-5 py-4 border-t border-slate-100 flex justify-end gap-2 bg-slate-50 rounded-b-2xl flex-shrink-0">
            {footer}
          </div>
        )}
      </div>
